...
function convertPokemonToLi(pokemon) {
    return `
        <li class="pokemon ${pokemon.types.map((type) => type).join(' ')}">
            ...
            <div class="pokemon-btn" id="btn-pokedetails">Informações Completas</div>
            <ul class="stats-board">
                <li id="board-att-li">Status</li>
                <li>Atributos</li>
            </ul>
            <ul class="main-stats">
...
document.addEventListener('click', function(e){
    if(e.target.innerText == "Informações Completas"){
    ...
    if(e.target.innerHTML == "Atributos"){
